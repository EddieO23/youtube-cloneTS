  ...
  const categoriesLinks = [
    {
      ...
      categoryId: categoriesData.find(
        (items: { snippet: { title: string } }) => items.snippet.title === "Music"
      )?.id,
    },
    {
    ...
    },
    {
      ...
      categoryId: categoriesData.find(
        (items: { snippet: { title: string } }) =>
          items.snippet.title === "News & Politics"
      )?.id,
    },
    {
      ...
      categoryId: categoriesData.find(
        (items: { snippet: { title: string } }) =>
          items.snippet.title === "Howto & Style"
      )?.id,
    },
    {
